 ...
 * Опционально (используют только достопримечательности). Слаги ↔ en/ru лейблы
 ...
 * для живущих в Черногории (риелторы, клининг и т.п.). Слаги ↔ ru/uk лейблы в i18n
 * (`serviceRubrics`).
 */
...
const articleBase = z.object({
  ...
  /**
   * Регион Черногории (§7) — фильтр/чип каталога достопримечательностей.
 ...
 * живущих в Черногории (риелторы, клининг, переезд и т.п.). Платное размещение —
