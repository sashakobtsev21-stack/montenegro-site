---
title: 'Budva, Montenegro: Old Town, Beaches & Nightlife'
description: 'Budva travel guide: the walled Old Town and citadel, Mogren, Jaz and Bečići beaches, Sveti Stefan, the Budva Riviera, nightlife and how to get there.'
slug: 'budva'
lang: 'en'
category: 'cities'
region: 'coastal'
...
cover:
  ...
  alt: 'View over Budva and its riviera with the old town, beaches and mountains behind, Montenegro'
coverCredit: 'Photo: Canes / Wikimedia Commons, CC BY-SA 4.0'
gallery:
  - src: '/images/budva/sea-walls.webp'
    alt: "Budva Old Town's stone sea walls rising straight from the Adriatic"
    credit: 'Photo: Richard Mortel / Wikimedia Commons, CC BY 2.0'
  - src: '/images/budva/old-town-lane.webp'
    alt: 'A narrow stone lane between shuttered houses in Budva Old Town'
    credit: 'Photo: Richard Mortel / Wikimedia Commons, CC BY 2.0'
  - src: '/images/budva/jaz-beach.webp'
    alt: 'The wide sweep of Jaz beach in a green bay west of Budva'
    credit: 'Photo: Bratislav Tabaš / Wikimedia Commons, Public domain'
  - src: '/images/budva/becici-beach.webp'
    alt: 'The long sandy strip of Bečići beach at sunset with the resort strip behind'
  ...
  - src: '/images/budva/riviera-panorama.webp'
    alt: 'Panorama of the Budva Riviera coast from Bečići towards Budva'
    credit: 'Photo: Natalia Semenova / Wikimedia Commons, CC BY 3.0'
affiliate:
  - partner: 'trip-hotels'
    label: 'Find hotels in Budva'
    position: 'body-end'
  - partner: 'trip-tours'
...
<figure class="figure">
<img src="/images/budva/old-town-aerial.webp" alt="Aerial view of Budva Old Town on its peninsula with the marina and red rooftops" width="1280" height="878" loading="lazy" decoding="async" />
<figcaption>Budva's walled Old Town sits on a small peninsula, with the marina and modern town spreading behind it. <span class="figure__credit">Photo: Dennis G. Jarvis / Wikimedia Commons, CC BY-SA 2.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/budva/citadel.webp" alt="The thick stone walls of the Citadel fortress at the tip of Budva Old Town" width="1280" height="829" loading="lazy" decoding="async" />
<figcaption>The Citadel guards the seaward point of the Old Town; its ramparts give the best views over Budva. <span class="figure__credit">Photo: Richard Mortel / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>

<figure class="figure">
<img src="/images/budva/santa-maria-church.webp" alt="The stone Santa Maria in Punta church with its red-tiled roof inside Budva Old Town" width="820" height="1094" loading="lazy" decoding="async" />
<figcaption>Santa Maria in Punta, a small medieval church near the seaward tip of the Old Town. <span class="figure__credit">Photo: Wolfgang Sauber / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
For more space, head a little out of town. **Jaz beach**, about 3 km west, is a wide open bay backed by green hills, with a sandy-pebble shore and room to breathe; it has hosted big open-air concerts over the years. **Bečići**, just east around the headland, is one of the longest and best-known sand beaches on the coast, lined with hotels and resorts and an easy walk or short drive from Budva. Between them, the Budva Riviera packs more named beaches into a few kilometres than anywhere else in the country. To see how they compare with the rest of the coast, from Ulcinj's long sands to Tivat's Plavi Horizonti, see our guide to the [best beaches in Montenegro](/attractions/best-beaches-in-montenegro/).

<figure class="figure">
<img src="/images/budva/mogren-beach.webp" alt="Mogren beach, a small sandy cove below wooded cliffs just outside Budva Old Town" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Mogren beach sits just beyond the Old Town walls, reached by a cliff-side path. <span class="figure__credit">Photo: Bratislav Tabaš / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>

| Beach | Distance from Old Town | Character |
|---|---|---|
| Slovenska plaža (town beach) | in town | Long, busy, fully serviced |
| Mogren | ~10 min walk | Scenic coves, cliff path, crowded |
| Jaz | ~3 km west | Wide open bay, more space |
| Bečići | ~3 km east | Long sandy resort beach |
...
<figure class="figure">
<img src="/images/budva/sveti-stefan.webp" alt="The island of Sveti Stefan with its stone houses joined to the shore by a causeway and beach" width="1280" height="851" loading="lazy" decoding="async" />
<figcaption>Sveti Stefan, the iconic island-hotel a few kilometres south of Budva, with its public beaches and causeway. <span class="figure__credit">Photo: Falk2 / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figcaption>The public beach beside the Sveti Stefan causeway, part of the Budva Riviera. <span class="figure__credit">Photo: Jaakko Luttinen / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
- **Kotor (~20 km).** The UNESCO walled town at the head of the Bay of Kotor is the obvious half- or full-day trip — see our [Kotor guide](/cities/kotor/) for the Old Town, the walls climb and boat tours of the bay.
...
| Day trip from Budva | Approx. distance | How to go |
|---|---|---|
| Sveti Stefan | ~5 km | Bus, taxi or car |
| Kotor | ~20 km | Bus, car or organised tour |
| Tivat / Porto Montenegro | ~20 km | Bus, taxi or car |
...
<figure class="figure">
<img src="/images/budva/sea-walls.webp" alt="The stone sea walls of Budva Old Town rising directly from the Adriatic" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The Old Town's sea walls drop straight into the Adriatic — you can walk much of the circuit beside the water. <span class="figure__credit">Photo: Richard Mortel / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
- **From Podgorica.** The capital and its airport are about an hour away by car or bus; see our [Podgorica travel guide](/cities/podgorica-travel-guide/) for the connections.
- **By car.** Driving gives the most flexibility for the riviera and day trips. The Old Town is pedestrian-only and parking near it fills quickly in season, so factor that in — see our guide to [renting a car in Montenegro](/car-rental/renting-a-car-in-montenegro/).
...
- **When to go.** July and August are hot, crowded and expensive — peak beach and party season. **Late spring and September** are far more comfortable for the Old Town and the beaches, with warm sea and thinner crowds. See our [best time to visit Montenegro](/planning/best-time-to-visit-montenegro/) guide for the seasonal picture.
...
For where Budva fits into a wider trip, our [Montenegro travel guide](/planning/montenegro-travel-guide/) maps the country region by region, and you can browse more destinations in our [cities guide](/cities/). Up the bay, [Kotor](/cities/kotor/) is the obvious next stop.
