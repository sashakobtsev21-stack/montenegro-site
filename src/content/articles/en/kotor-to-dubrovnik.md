---
title: 'Kotor to Dubrovnik: Bus, Transfer & Border Crossing'
description: 'Kotor to Dubrovnik in 2026: bus times and fares, private transfers, the Debeli Brijeg border crossing, EES checks and the reverse Dubrovnik–Kotor trip.'
...
cover:
  ...
  alt: 'Intercity coach on the coastal road heading from Kotor toward Dubrovnik, Montenegro'
coverCredit: 'Photo: Hibasi / Wikimedia Commons, CC BY-SA 4.0'
gallery:
  - src: '/images/kotor-to-dubrovnik/bay-lepetane.webp'
    alt: 'View across the Bay of Kotor from Lepetane, on the coastal route toward the Croatian border'
    credit: 'Photo: Alexkom000 / Wikimedia Commons, CC BY 4.0'
  - src: '/images/kotor-to-dubrovnik/bay-stoliv.webp'
    alt: 'The inner Bay of Kotor seen from Stoliv, Montenegro'
    credit: 'Photo: Misa.stefanovic.07 / Wikimedia Commons, CC BY-SA 4.0'
affiliate:
  - partner: 'kiwitaxi'
    label: 'Book a Kotor–Dubrovnik private transfer'
    position: 'body-end'
sources:
  - 'rome2rio.com'
  - 'checkmybus.com'
...
The fastest way from Kotor to Dubrovnik is a **direct bus**, which takes about **2 to 3 hours** for roughly **€20–30** and runs **5–6 times a day** in summer. The catch is the **Debeli Brijeg border crossing**: Croatia has been in the Schengen Area since January 2023, so this is now a hard external frontier with **passport checks both ways** (figures and rules checked June 2026 — reconfirm before you travel). Below is how the bus works, when a private transfer makes more sense, what to expect at the border, and how to do the trip in reverse.
...
<figure class="figure">
<img src="/images/kotor-to-dubrovnik/dubrovnik-oldtown.webp" alt="Evening view over Dubrovnik, Croatia, the end point of the route from Kotor" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Dubrovnik is the usual end of the line — most buses set down at the main bus station in Gruž, a short local bus or taxi from the old town. <span class="figure__credit">Photo: donald judge / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>

## Taking the bus

Buses leave from **Kotor's main bus station**, just south-east of the old town, and arrive at **Dubrovnik bus station in Gruž**, about 3 km from the walled old town (local bus 1A/1B or a taxi covers the last stretch). Several operators share the route — among them **Blue Line, Jadran Ekspres, Globtour and Croatia Bus** — so in peak season you have **5–6 departures a day**, thinning out in winter.

Reckon on a **scheduled 2h to 2h 30m**, though the real total depends entirely on the border queue. Fares run roughly **€20–30 one way** (checked June 2026 — reconfirm); buying ahead online through the operator or an aggregator usually beats the on-the-day counter price and guarantees a seat in July and August.
...
<figure class="figure">
<img src="/images/kotor-to-dubrovnik/coastal-road.webp" alt="Narrow coastal road along the Bay of Kotor between Perast and Dobrota, on the route north to Croatia" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The first part of the drive hugs the Bay of Kotor before the road opens out toward Herceg Novi and the border. <span class="figure__credit">Photo: Alexkom000 / Wikimedia Commons, CC BY 4.0</span></figcaption>
</figure>
...
The trip works the same way in the other direction, with the same operators, the same Debeli Brijeg / Karasovići crossing and similar fares of **€20–30** (checked June 2026 — reconfirm). Buses leave **Dubrovnik's Gruž bus station** and set down at **Kotor's main bus station**; the scheduled run is again around **2h–2h 30m** before the queue.
...
Crossing to Dubrovnik pairs naturally with the rest of your Montenegro travel. For the bigger picture of buses, taxis and ferries around the country, see [getting around Montenegro](/transport/getting-around-montenegro/); to plan your time in the bay itself, start with the [Kotor guide](/cities/kotor/). Cross early, keep your passport handy, and the border is just a pause in one of the prettiest coastal rides in the Adriatic.
