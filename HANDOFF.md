...
**Дата:** 2026-06-30 · **Фаза:** R4 наполнение · **Статей:** 29 + 3 маршрута (цель ~80) · **Сайт:** live (`montenegroguidebook.com`) · **Языки:** en/ru · **Последний коммит:** `content(montenegro): photo top-up to ≥5 on 6 articles (en+ru)`
