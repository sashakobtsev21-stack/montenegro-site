...
> **YMYL note — verify before you rely on this.** We deliberately do not print a fixed income number, because it moves. Confirm the current minimum-income threshold, document list, validity period and tax implications directly with the official source — the Government of Montenegro and the Ministry of Interior (MUP) at [gov.me](https://www.gov.me) — before making any plans. This article was checked on **21 June 2026**; rules may have changed since.
