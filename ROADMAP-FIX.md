...
- [ ] 🟡 **Добор фото до ≥5** по статьям, где сейчас <5 (часть ранних материалов на `cover + 3` инлайн = 4; новая норма — `cover + ≥4`). Сейчас в репо **29 статей + 3 маршрута**; пройтись по тем, что ниже нормы. Гейт `check-photos` пока требует меньше (cover + ≥3 инлайн / ≥6 gallery), поэтому qa зелёный; ужесточать гейт — только после добора.
