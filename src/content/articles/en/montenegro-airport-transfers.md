---
title: 'Montenegro Airport Transfers: Tivat, Podgorica & Dubrovnik'
description: 'How to get from Tivat, Podgorica and Dubrovnik airports to Montenegro resorts in 2026: private transfers, taxis and buses, with rough fares and times.'
...
cover:
  ...
  alt: 'A white transfer minibus and cars outside the terminal at Dubrovnik Airport'
coverCredit: 'Photo: Sharon Hahn Darlin / Wikimedia Commons, CC BY 4.0'
gallery:
  - src: '/images/montenegro-airport-transfers/dubrovnik-airport-aerial.webp'
    alt: 'Aerial view of Dubrovnik (Čilipi) Airport runway with the Adriatic coast beyond'
    credit: 'Photo: Bracodbk / Wikimedia Commons, CC BY-SA 3.0'
affiliate:
  - partner: 'kiwitaxi'
    label: 'Book a Montenegro airport transfer'
    position: 'body-end'
  - partner: 'trip-transfers'
    label: 'Compare private transfer prices'
    position: 'body-end'
sources:
...
Not sure which to book a flight into in the first place? Our [Tivat vs Podgorica airport](/transport/tivat-vs-podgorica-airport/) comparison weighs distance, cost and flight choice.
...
The step-by-step on each option, including which buses run the Tivat–Kotor stretch, is in our [Tivat Airport to Kotor guide](/transport/tivat-airport-to-kotor/).

<figure class="figure">
<img src="/images/montenegro-airport-transfers/herceg-novi.webp" alt="Herceg Novi old town descending to the Bay of Kotor, with mountains across the water" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Herceg Novi, on the western arm of the Bay of Kotor, is the closest Montenegrin town to Dubrovnik Airport — about 30 km. <span class="figure__credit">Photo: Alexkom000 / Wikimedia Commons, CC BY 4.0</span></figcaption>
</figure>
...
The full breakdown — taxi vs transfer vs the bus-via-Podgorica route — is in our [Podgorica Airport to Budva guide](/transport/podgorica-airport-to-budva/).

<figure class="figure">
<img src="/images/montenegro-airport-transfers/podgorica-bus.webp" alt="A red city bus on a street in Podgorica with another bus behind it" width="1280" height="852" loading="lazy" decoding="async" />
<figcaption>Buses are the budget option from Podgorica, but you first need a short taxi from the airport to the main bus station. <span class="figure__credit">Photo: Francisco Antunes / Wikimedia Commons, CC BY 2.0</span></figcaption>
</figure>
...
**The border crossing.** The coastal route uses **Debeli Brijeg–Karasovići**, with two checkpoints about 2 km apart — you stop to exit Croatia and again to enter Montenegro, with a passport check each time. Croatia is in the Schengen Area, so this is a real external frontier: **EU/EEA/Swiss** travellers can use a national ID card, while **UK, US, Canadian and Australian** visitors need a passport (most stay visa-free for short trips). Queues are short out of season (15–30 min) but can run to an hour or more on summer weekend mornings; a quieter alternative is the smaller **Konfin / Njivice** crossing near Prevlaka. We cover the crossing in detail in the [Kotor to Dubrovnik guide](/transport/kotor-to-dubrovnik/), which works the same in reverse.

<figure class="figure">
<img src="/images/montenegro-airport-transfers/kamenari-ferry.webp" alt="The Kamenari–Lepetane ferries moored on the Bay of Kotor with mountains behind" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>The Kamenari–Lepetane ferry cuts across the mouth of the bay and shortens the drive from the Herceg Novi side toward Tivat and Budva. <span class="figure__credit">Photo: Sharon Hahn Darlin / Wikimedia Commons, CC BY 4.0</span></figcaption>
</figure>
...
Once you're off the plane and on the road, the rest of the country is easy to piece together. For buses, taxis and ferries countrywide, see [getting around Montenegro](/transport/getting-around-montenegro/); if you'd rather drive yourself from the airport, read [renting a car in Montenegro](/car-rental/renting-a-car-in-montenegro/) and the notes on [driving in Montenegro](/transport/driving-in-montenegro/) before you set off. Book the transfer that matches your airport and your group, and the journey from runway to resort is the simple part of a Montenegro trip.
