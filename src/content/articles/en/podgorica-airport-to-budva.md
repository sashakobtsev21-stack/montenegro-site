---
title: 'Podgorica Airport to Budva: Taxi, Transfer & Bus Options'
description: 'Podgorica Airport (TGD) to Budva in 2026: ~65 km and about an hour. Compare taxi, private transfer and the bus-via-Podgorica route, with fares.'
...
cover:
  ...
  alt: 'Budva old town with the church bell tower and the island of Sveti Nikola offshore, the destination from Podgorica Airport'
coverCredit: 'Photo: Diego Delso / Wikimedia Commons, CC BY-SA 3.0'
gallery:
  - src: '/images/podgorica-airport-to-budva/budva-lane.webp'
    alt: 'A narrow stone lane in Budva old town, a short walk from the central bus station'
    credit: 'Photo: ines lukic / Wikimedia Commons, CC BY 3.0'
affiliate:
  - partner: 'kiwitaxi'
    label: 'Book a Podgorica–Budva transfer'
    position: 'body-end'
...
|---|---|---|---|
| Taxi (from the rank) | ~1h 10m | ~€50–60 | Most arrivals, door to door |
| Private transfer (booked) | ~1h 10m | fixed, ~€50–60 | A set price, a driver waiting |
| Bus via Podgorica station | ~2h+ all in | ~€8–20 total | Solo or pairs on a budget |
...
<figure class="figure">
<img src="/images/podgorica-airport-to-budva/podgorica-airport.webp" alt="The terminal frontage of Podgorica Airport with the apron visible through the glass" width="1280" height="721" loading="lazy" decoding="async" />
<figcaption>Podgorica Airport (TGD) is the inland gateway — Budva is about 65 km away over the coastal mountains. <span class="figure__credit">Photo: Bjoertvedt / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/podgorica-airport-to-budva/intercity-bus.webp" alt="A Montenegrin intercity coach operated by 4 Decembar on a coastal road with mountains behind" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Intercity coaches like this 4. Decembar bus link Podgorica's main station with Budva for a few euros — but you have to reach the station from the airport first. <span class="figure__credit">Photo: Miodrag95 / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/podgorica-airport-to-budva/budva-citadel.webp" alt="Budva old town rooftops, the church bell tower and the sea seen from the citadel walls" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Budva's walled old town from above — whichever way you travel from TGD, this is where the road ends. <span class="figure__credit">Photo: Milos Mandic / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
- **Touring Montenegro afterwards:** skip transfers and pick up a [hire car](/car-rental/renting-a-car-in-montenegro/) at the airport.

For the wider context — including how Podgorica compares with the coastal airport — see [Tivat vs Podgorica airport](/transport/tivat-vs-podgorica-airport/) and our umbrella guide to [airport transfers in Montenegro](/transport/montenegro-airport-transfers/). To plan the rest of the journey, the [getting around Montenegro](/transport/getting-around-montenegro/) guide covers buses, taxis and ferries, and the [Budva guide](/cities/budva/) sorts out where to stay and what to do once you arrive. Pick the option that fits your group and your budget, and TGD to Budva is a straightforward run to the coast.
