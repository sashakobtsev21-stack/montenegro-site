---
title: 'Tivat Airport to Kotor: Taxi, Transfer & Bus Options'
description: 'How to get from Tivat Airport (TIV) to Kotor in 2026: taxis, pre-booked transfers and the budget coastal bus — distances, rough fares and tips.'
...
cover:
  ...
  alt: 'Tivat Bay with the runway of Tivat Airport on the shore, seen from the hills above, mountains beyond'
...
| Option | Rough time | Rough cost (2026) | Best for |
|---|---|---|---|
| Taxi (from the rank) | 15–20 min | ~€15–25 | Most arrivals, groups, late flights |
| Pre-booked private transfer | 15–20 min | fixed, from ~€20–30 | A guaranteed price and a driver waiting |
| Coastal intercity bus | 30–45 min + walk | a few euros | Budget travellers with light luggage |
| Hire car | 20 min | — | If you’re touring Montenegro after |
...
<figure class="figure">
<img src="/images/tivat-airport-to-kotor/tivat-airport.webp" alt="Inside the passenger terminal at Tivat Airport with check-in desks and waiting passengers" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Tivat Airport is small and seasonal — busy in summer, with the taxi rank and transfer meeting point right outside arrivals. <span class="figure__credit">Photo: Vitorabdala / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
For the bigger picture of how the airport fits the region — including the inland alternative, Podgorica (TGD) — see our [Tivat town guide](/cities/tivat/) and the country-wide [getting around Montenegro](/transport/getting-around-montenegro/) guide.

<figure class="figure">
<img src="/images/tivat-airport-to-kotor/bay-panorama.webp" alt="A wide panorama of the Bay of Kotor with Tivat and its airport on the left and Kotor at the head of the bay on the right" width="1280" height="408" loading="lazy" decoding="async" />
<figcaption>The whole trip in one view: Tivat and its airport on the left, Kotor tucked at the head of the bay on the right — only about 8 km apart by road. <span class="figure__credit">Photo: Javier Sánchez Portero / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/tivat-airport-to-kotor/bay-road.webp" alt="The shore of the Bay of Kotor near Lepetane with a small waterside chapel and islands in the distance" width="1280" height="869" loading="lazy" decoding="async" />
<figcaption>The road from Tivat to Kotor hugs the shore of the bay — short and scenic, though it backs up in midsummer. <span class="figure__credit">Photo: Gzzz / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
Whichever you pick, it’s a short trip — Tivat to Kotor is one of the quickest airport runs on the Adriatic. Montenegro uses the **euro (€)**; keep a little cash for the bus, any taxi rounding and parking machines, even though cards are widely accepted. To plan the onward journey, see our [Kotor guide](/cities/kotor/) and the full [getting around Montenegro](/transport/getting-around-montenegro/) guide.

## Nearby / read also

- [Getting around Montenegro](/transport/getting-around-montenegro/) — buses, taxis, car hire and ferries countrywide.
- [Tivat travel guide](/cities/tivat/) — the airport town, Porto Montenegro and the beaches.
- [Kotor guide](/cities/kotor/) — what to do once you arrive.
- [Renting a car in Montenegro](/car-rental/renting-a-car-in-montenegro/) — if you’re touring on.
