---
title: 'Getting Around Montenegro: Buses, Taxis, Car & Ferries'
description: 'How to get around Montenegro: intercity buses, taxis, hire cars, the Bay of Kotor ferry, trains and Italy ferries — with realistic 2026 fares and times.'
...
cover:
  ...
  alt: 'The Kamenari–Lepetane car ferry loaded with vehicles crossing the Bay of Kotor, Montenegro'
...
affiliate:
  - partner: 'localrent'
    ...
    position: 'body-end'
  - partner: 'kiwitaxi'
    label: 'Book a private airport transfer'
    position: 'body-end'
sources:
  - 'busticket4.me'
  - 'blueline-mne.com'
...
- **Podgorica–Kotor:** around €8–12, about 2–2.5 hours.
...
<figure class="figure">
<img src="/images/getting-around-montenegro/intercity-bus.webp" alt="A Jadran Ekspres intercity coach at a Montenegrin bus station with a Budva–Dubrovnik destination sign" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>Intercity coaches like this one link the coastal towns and cross-border routes to Dubrovnik for a few euros. <span class="figure__credit">Photo: Hibasi / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-montenegro/mountain-road.webp" alt="A road tunnel cut through bare rock in the Tara Canyon, northern Montenegro" width="1000" height="750" loading="lazy" decoding="async" />
<figcaption>Single-lane tunnels hacked through the rock are part of the deal on the mountain roads north of the coast. <span class="figure__credit">Photo: Pudelek (Marcin Szala) / Wikimedia Commons, CC BY-SA 3.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-montenegro/bar-train-station.webp" alt="The railway station building at Bar, the coastal terminus of Montenegro's main rail line" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Bar is the coastal end of the line — the start of the scenic climb to Podgorica, Kolašin and on to Belgrade. <span class="figure__credit">Photo: Niegodzisie / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/getting-around-montenegro/tivat-airport-bay.webp" alt="The runway of Tivat Airport on the shore of Tivat Bay, with the mountains of the Bay of Kotor beyond" width="1280" height="960" loading="lazy" decoding="async" />
<figcaption>Tivat's single runway sits right on the bay — the coastal airport for Kotor, Budva and the Boka. <span class="figure__credit">Photo: Calistemon / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>

You can also arrive by sea. Seasonal **ferries from Italy** — **Bari–Bar** and **Ancona–Bar** — run mainly in the **July–September** summer window. The Bari crossing takes roughly **8–11 hours**, and both the operator and the timetable shift from year to year, so check the current schedule and whether your sailing is daytime or overnight before booking. They are most useful if you are bringing your own car from Italy.
...
- [Tivat vs Podgorica Airport](/transport/tivat-vs-podgorica-airport/) — which airport to fly into for the coast or the north.
- [Airport transfers in Montenegro](/transport/montenegro-airport-transfers/) — Tivat, Podgorica and Dubrovnik options compared.
- [Podgorica Airport to Budva](/transport/podgorica-airport-to-budva/) — taxi, transfer and the bus via Podgorica.
