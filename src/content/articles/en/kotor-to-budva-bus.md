---
title: 'Kotor to Budva: Bus, Taxi & Driving (How to Get There)'
description: 'Kotor to Budva in 2026: frequent buses from about EUR 4, taxi fares, driving via the Vrmac tunnel or the coast, and parking in Budva — all your options.'
...
cover:
  ...
  alt: 'View over Budva on the Montenegrin coast, the destination of the short hop from Kotor'
coverCredit: 'Photo: Nick Savchenko / Wikimedia Commons, CC BY-SA 2.0'
gallery:
  - src: '/images/kotor-to-budva-bus/tivat-route.webp'
    alt: 'View over the Bay of Kotor near Tivat, on the coastal road option between Kotor and Budva'
...
<figure class="figure">
<img src="/images/kotor-to-budva-bus/kotor-port.webp" alt="Kotor old town and port below the fortress walls, the starting point of the trip to Budva" width="1280" height="761" loading="lazy" decoding="async" />
<figcaption>The trip starts at Kotor bus station, a short walk south of the old town below the fortress. <span class="figure__credit">Photo: Morganjgonzalez / Wikimedia Commons, CC BY-SA 4.0</span></figcaption>
</figure>
...
<figure class="figure">
<img src="/images/kotor-to-budva-bus/tivat-route.webp" alt="The Bay of Kotor near Tivat, on the longer coastal driving route to Budva" width="1280" height="853" loading="lazy" decoding="async" />
<figcaption>The coastal route via Tivat is longer than the tunnel but swaps the queue for bay views. <span class="figure__credit">Photo: Alexkom000 / Wikimedia Commons, CC BY 4.0</span></figcaption>
</figure>
...
Kotor and Budva are the two anchors of the central coast, and hopping between them is one of the first things most visitors do. For the wider picture of buses, taxis and ferries across the country, see [getting around Montenegro](/transport/getting-around-montenegro/); if you would rather have your own wheels for the coast and the mountains, our guide to [renting a car in Montenegro](/car-rental/renting-a-car-in-montenegro/) covers costs and pickup points. To plan your time at each end, start with the [Kotor guide](/cities/kotor/) and the [Budva guide](/cities/budva/). On this route, the bus is usually the answer — frequent, cheap and quicker than fighting for a parking space.
