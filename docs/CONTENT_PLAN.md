...
- **Опубликован первый кластер (5 статей, 2026-06-21):** `montenegro-travel-guide`, `best-time-to-visit-montenegro`, `renting-a-car-in-montenegro`, `cost-of-living-in-montenegro`, `durmitor-national-park` — все en/ru (uk-версии удалены 2026-06-22), обложка+3 figure, кластер-перелинковка, гейты зелёные (`qa` = GO). Остальное ниже — ⬜.
...
> **Готово 2026-06-21:** пункты 1–5 (первый кластер, en/ru — uk-версии удалены 2026-06-22, `qa` = GO). Дальше:
...
- ✅ **Hero-картинки и `og-default`** — кадры Черногории (Бока-Которска, Дурмитор, Свети-Стефан, Будва, Ловчен); `og-default.jpg` = Которский залив; favicon = флаг Черногории. *(сделано 2026-06)*
